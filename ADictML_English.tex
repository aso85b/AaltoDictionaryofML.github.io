...
%\newglossary*{fl}{Federated Learning}
\newglossary*{math}{Mathematical Tools}
\newglossary*{mlsystems}{ML Systems}
\newglossary*{advanced}{Advanced Terms}
\newglossary*{regulation}{ML Regulation}
\newglossary*{reinflearning}{Reinforcement Learning}
\newglossary*{healthcare}{Health Care}
...
\usepackage{breakurl} % Allows the url:s to be broken to multiple lines 
...
\input{ADictML_Regulation.tex}
\input{ADictML_MLSystems.tex}
\input{ADictML_Math.tex}
\input{ADictML_RL.tex}
\input{ADictML_Glossary_English.tex}
\input{ADictML_HealthCare.tex}
...
\author{\hspace{-2mm}Alexander Jung${}^{1}$, \ Konstantina Olioumtsevits${}^{1}$, \ 
	...
	Juliette Gronier${}^{2}$, Salvatore Rastelli${}^{1}$, and \\[-2mm] Mikko Seesto${}^{1}$ \\[-2mm]
...
%	\resizebox{4cm}{\qrcode{https://github.com/AaltoDictionaryofML/AaltoDictionaryofML.github.io}}\\[10mm]
{\large	please cite as: A.\ Jung, K.\ Olioumtsevits, E.\ Schnoor, T.\ Ryynänen, J.\ Gronier, S.\ Rastelli, and M.\ Seesto, \textit{The Aalto Dictionary of Machine Learning}. Espoo, Finland: Aalto University, 2026.}
\end{center}

\newpage 
\noindent{\bf\Large Acknowledgment} % Should this be plural?
...
\printglossary[type=math,title={Mathematical Tools}, nonumberlist]

\newpage
\printglossary[title={Machine Learning Concepts}, nonumberlist]

%\newpage
%\printglossary[type=fl, title={Federated Learning}, nonumberlist]

\newpage
\printglossary[type=reinflearning, title={Reinforcement Learning}, nonumberlist]

\newpage
\printglossary[type=mlsystems, title={Machine Learning Systems}, nonumberlist]

\newpage
\printglossary[type=regulation, title={Machine Learning Regulation}, nonumberlist]

\newpage
\printglossary[type=healthcare, title={Health Care}, nonumberlist]
